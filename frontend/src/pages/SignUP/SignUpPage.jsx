...
const SignUpPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setStatus({
        type: "error",
        message: error.message || "Registration sequence failed.",
      });
    } finally {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl opacity-20 animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="kinetic-reveal p-10 bg-[#0a0e27]/40 backdrop-blur-2xl rounded-2xl border border-cyan-500/20" style={{ "--delay": "150ms" }}>
          ...
          <div className="flex gap-8 border-b border-cyan-500/10 pb-6 mb-10">
            <Link to="/login" className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-500 hover:text-gray-300 transition">
              Authorize
            </Link>
          ...
          <div className="mb-10 space-y-2">
            <h1 className="text-4xl font-black text-white tracking-tight uppercase leading-none">Initialize_ <br /><span className="text-cyan-400">Access</span></h1>
            <p className="text-xs text-gray-500 uppercase tracking-widest font-mono">Quantum_Registration_v2.0</p>
          </div>

          {/* Form */}
          <form className="space-y-8" onSubmit={handleSubmit}>
            <div className="space-y-2">
               <p className="text-[9px] font-black uppercase tracking-[0.4em] text-gray-600">User_Alias</p>
               <input 
                 type="text"
                 name="username"
                 value={form.username}
            ...
            <div className="space-y-2">
               <p className="text-[9px] font-black uppercase tracking-[0.4em] text-gray-600">Neural_Address</p>
               <input 
                 type="email"
                 name="email"
                 value={form.email}
            ...
            >
              {isSubmitting ? "Synthesizing..." : "Synthesize Identity"}
            </Button>
          </form>
